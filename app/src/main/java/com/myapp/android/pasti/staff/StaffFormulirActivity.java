...
public class StaffFormulirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_formulir);
...
//                            }
//                        });
                firestore.collection("Formulir").document(id).update("checkStatusStaff", true);
                Toast.makeText(getApplicationContext(),"Formulir Diterima", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(StaffFormulirActivity.this, StaffListFormulirActivity.class);
